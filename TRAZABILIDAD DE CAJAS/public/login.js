    ...
    if (loginForm) {
        loginForm.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                // Buscar y guardar roles extras si existen
                querySnapshot.forEach((doc) => {
                    const userData = doc.data();
                    ...
                    if (userData.role_deposito) {
                        localStorage.setItem('roleDeposito', userData.role_deposito);
                    } else {
                        localStorage.removeItem('roleDeposito');
                    }
                });
                ...
                } else if (userApps.length === 1 && userApps[0] === 'deposito') {
                    window.location.href = 'deposito/menu.html';
                } else {
